    ...
    if ($statement - > rowCount() == 1) {
      ...
      if ($degree != "") {
        ...
        if ($thirdstart - > rowCount() >= 1) {
          ...
          //in a situation where the job entered was not present. If I want the data for the other degrees, even when the job 
      ...
      //check if degree exists in rows where job does not	
